...
POSITIVE_DATA_PATH = os.path.join(PROJECT_PATH, 'DataSet\\positive')
NEGETIVE_DATA_PATH = os.path.join(PROJECT_PATH, 'DataSet\\negetive')
'''
...
def divisionTrainData(filePath, positivePath, negetivePath):
    # 创建类别目录
    os.mkdir(os.path.join(PROJECT_PATH, 'DataSet'))
